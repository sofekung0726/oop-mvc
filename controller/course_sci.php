                ...
                <div class="col-lg-8" >
                    ...
                    <article >
                        ...
                        <header class="mb-4">
                            ...
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1"><?php echo $rs2['cs_name'];?></h1>
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2"><i class="far fa-calendar-alt"></i><?php echo $rs2['cs_date'];?></div>
                        ...
                        <figure class="mb-4"><img class="img-fluid rounded" src="../<?php echo $rs2['cs_img'];?>" alt="..." /></figure>
                        <!-- Post content-->
